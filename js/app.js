...
let c = sumArr[2];
console.log(c);
let first2 = sum(a, b)[0];
console.log(first2)
let last1 = sum(first2, c)[0];
console.log(last1);

return[last1, `${a},${b},${c} was passed in as an array of numbers, and ${last1} is their sum.`]
}
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    let c = multArr[2];
    console.log(c);
    let first2 = multiply(a, b)[0];
    console.log(first2)
    let last1 = multiply(first2, c)[0];
    console.log(last1);

    return[last1 ,`The numbers ${a},${b},${c} have a product of ${last1}.`]
}
